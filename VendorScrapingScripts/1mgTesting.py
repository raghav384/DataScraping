...
def find_all_medicine_urls(website_url):
    ...
    output = soup.find_all("div",{"class":"Card__container__2Kvce Card__productCard__2MScM Card__direction__1UZ-g container-fluid-padded-xl"})
    print(len(output))
    ...
    print("DatabaseInsertionStart")
    mongo_insert_multi_thread(medicine_records_list)
    print("DatabaseInsertionEnd")
    medicine_records_list = []
